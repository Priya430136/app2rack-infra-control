  ...
  return (
    ...
    >
      ...
      <GlassPanel style={{ padding: "18px 26px", marginTop: 10, opacity: enter(frame, 4, fps) }}>
        <div
          style={{ fontFamily: body, fontSize: 12, color: theme.mutedForeground, letterSpacing: 1 }}
        >
          WELCOME BACK
        </div>
        <div
      ...
      <div style={{ display: "flex", gap: 16, marginTop: 18 }}>
        <GlassPanel style={{ padding: 22, flex: 1.6 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div>
              ...
              <div style={{ fontFamily: body, fontSize: 11.5, color: theme.mutedForeground }}>
        ...
        <GlassPanel style={{ padding: 22, flex: 1 }}>
          <div
            style={{ fontFamily: display, fontSize: 15, fontWeight: 600, color: theme.foreground }}
          >
            Server Health
          </div>
          <div style={{ fontFamily: body, fontSize: 11.5, color: theme.mutedForeground }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 6, marginTop: 6 }}>
            {[
              ...
              >
                ...
                {r.l}{" "}
                <span style={{ marginLeft: "auto", color: theme.foreground, fontWeight: 600 }}>
                  {r.v}
                </span>
              </div>
            ))}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          {loadServers.map((s, i) => (
            <div key={s.name} style={{ display: "flex", alignItems: "center", gap: 14 }}>
              <span style={{ fontFamily: mono, fontSize: 12, color: theme.foreground, width: 110 }}>
                {s.name}
              </span>
              <ProgressBar value={s.pct} color={theme.chart1} delay={70 + i * 6} width={480} />
              <span style={{ fontFamily: mono, fontSize: 12, color: theme.mutedForeground }}>
                {s.pct}%
              </span>
            </div>
          ))}
