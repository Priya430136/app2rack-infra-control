...
const INCIDENTS = [
  ...
  {
    title: "5xx error rate elevated on srv-node-13",
    sev: "High",
    status: "Resolved",
    downtime: "7m",
  },
...
export const Scene10Incidents: React.FC = () => {
  ...
  return (
    <AppFrame
      active="Incidents"
      title="Incidents"
      subtitle="7 active · severity-graded timeline & downtime tracking"
    >
      <div
        style={{
          fontFamily: mono,
      ...
      <GlassPanel style={{ padding: 0, overflow: "hidden" }}>
        ...
        {INCIDENTS.map((inc, i) => {
          ...
          return (
            ...
            >
              <span style={{ fontFamily: display, fontSize: 14, color: theme.foreground }}>
                {inc.title}
              </span>
              <span>
              ...
              <span style={{ fontFamily: mono, fontSize: 12.5, color: theme.mutedForeground }}>
                {inc.downtime}
              </span>
            </div>
          );
      ...
      <GlassPanel style={{ marginTop: 16, padding: 20, opacity: enter(frame, 70, fps) }}>
        ...
        <div style={{ display: "flex", gap: 28, position: "relative" }}>
          ...
          {[
            ...
            <div
              key={i}
              style={{ position: "relative", flex: 1, opacity: enter(frame, 80 + i * 8, fps) }}
            >
              <div
                style={{
                  width: 10,
                  ...
                  boxShadow: `0 0 10px ${theme.chart1}`,
                }}
              />
              <div
                style={{
              ...
              <div
                style={{ fontFamily: body, fontSize: 12.5, color: theme.foreground, marginTop: 2 }}
              >
                {step.e}
              </div>
            </div>
