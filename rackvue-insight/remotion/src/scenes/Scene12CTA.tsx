...
export const Scene12CTA: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ alignItems: "center", justifyContent: "center", flexDirection: "column", background: theme.background }}>
      <AbsoluteFill
        style={{
          background:
      ...
      />
      <div style={{ display: "flex", alignItems: "center", gap: 18, transform: `translateY(${y}px)`, opacity: wordmark }}>
        <div
          style={{
            width: 72,
            height: 72,
        ...
        >
          <svg width={36} height={36} viewBox="0 0 24 24" fill="none" stroke={theme.background} strokeWidth={2.5}>
            <path d="M3 12h4l3 8 4-16 3 8h4" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
        <div style={{ fontFamily: display, fontWeight: 700, fontSize: 84, letterSpacing: -3, color: theme.foreground }}>App2Rack</div>
      </div>
      ...
      <div style={{ marginTop: 46, display: "flex", alignItems: "center", gap: 18, transform: `scale(${chipOp})`, opacity: chipOp }}>
        <div
          style={{
            padding: "18px 40px",
            borderRadius: 12,
        ...
        <div style={{ padding: "16px 36px", borderRadius: 12, border: `1px solid ${theme.border}`, color: theme.foreground, fontFamily: mono, fontSize: 17, letterSpacing: 1 }}>
