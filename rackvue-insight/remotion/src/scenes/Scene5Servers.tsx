...
const Meter: React.FC<{ label: string; value: number; color: string; delay: number }> = ({
  label,
  value,
  color,
  delay,
...
export const Scene5Servers: React.FC = () => {
  ...
  return (
    <AppFrame
      ...
      subtitle="36 servers · CPU, RAM & storage utilization"
    >
      <div
        style={{
          fontFamily: mono,
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, width: 210 }}>
                <span
                  style={{
                    ...
                    boxShadow: `0 0 8px ${statusColor(s.status)}`,
                  }}
                />
                <div>
                  <div
                  ...
                  <div style={{ fontFamily: mono, fontSize: 10.5, color: theme.mutedForeground }}>
                    {s.host}
                  </div>
                </div>
              </div>
              <div
                style={{ width: 150, fontSize: 12, color: theme.mutedForeground, fontFamily: body }}
              >
                {s.os}
              </div>
