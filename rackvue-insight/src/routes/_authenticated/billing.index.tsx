      ...
      <div className="p-6 grid gap-4 lg:grid-cols-3">
        <Card className="lg:col-span-2 border-border/60 bg-card/60 p-6 backdrop-blur">
          <div className="mb-4 flex items-start justify-between">
            ...
            <Button asChild className="bg-gradient-to-r from-primary to-chart-4">
          ...
          <div className="grid gap-4 sm:grid-cols-3 border-t border-border/40 pt-4">
            <div>
              ...
              <p className="font-medium capitalize">{sub?.billing_cycle ?? "monthly"}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="truncate font-mono text-xs">{sub?.id ?? "—"}</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="border-border/60 bg-card/60 p-6 backdrop-blur">
          ...
          <p className="mb-3 text-xs text-muted-foreground">
            of {wallet?.monthly_allowance ?? 0} monthly
          </p>
          <Button asChild size="sm" variant="outline" className="w-full">
            <Link to="/billing/credits">Manage Credits</Link>
          </Button>
        </Card>
        ...
        <Card className="lg:col-span-3 border-border/60 bg-card/60 backdrop-blur">
          ...
          <div className="p-6">
            <p className="text-sm">
              Mock payment provider · <span className="text-muted-foreground">Ending in 4242</span>
            </p>
            <Button
              size="sm"
              variant="outline"
              className="mt-3"
              onClick={() => toast.info("Payment method update coming with Stripe integration")}
            >
              Update
            </Button>
          </div>
