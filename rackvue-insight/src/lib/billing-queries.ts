...
export const creditPackagesQO = queryOptions({
  queryKey: ["credit-packages"],
  queryFn: () => listCreditPackages(),
});
export const mySubscriptionQO = queryOptions({
  queryKey: ["my-subscription"],
  queryFn: () => getMySubscription(),
});
export const myWalletQO = queryOptions({ queryKey: ["my-wallet"], queryFn: () => getMyWallet() });
export const myTransactionsQO = queryOptions({
  queryKey: ["my-transactions"],
  queryFn: () => listMyTransactions(),
});
export const myInvoicesQO = queryOptions({
