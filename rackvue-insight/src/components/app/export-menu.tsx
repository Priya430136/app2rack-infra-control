  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-44">
        ...
        <DropdownMenuItem onClick={() => exportCSV(rows as unknown as Record<string, unknown>[], filename)}>
          <FileSpreadsheet className="mr-2 h-4 w-4" />CSV
        </DropdownMenuItem>
        <DropdownMenuItem onClick={() => exportPDF({ rows: rows as unknown as Record<string, unknown>[], filename, title, subtitle })}>
